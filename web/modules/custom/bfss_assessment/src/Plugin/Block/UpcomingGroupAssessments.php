  ...
  public function build() {
    ...
    if(isset($param['SearchAssessments'])){
      $nids = $this->assessmentService->Assessments_Search_Filter($element,$param['SearchAssessments'],'group');
        ...
        $nids = $this->assessmentService->assessment_categories_filter($element,'group');
    }elseif(isset($param['tags'])){
       $nids = $this->assessmentService->assessment_tags_filter($element,'group');
    }elseif(isset($param['state']) && isset($param['city'])){
      $nids = $this->assessmentService->assessment_venues_filter($element,'group');
    }
    else{
