...
use Drupal\bfss_registration_form\Manager\StepManager;
use Drupal\bfss_registration_form\Step\StepsEnum;

/**
 * Provides multi step ajax example form.
 *
 * @package Drupal\bfss_registration_form\Form
 */
class MultiStepExampleForm extends FormBase {
   ...
   * Step Id.
   *
   * @var \Drupal\bfss_registration_form\Step\StepsEnum
   */
  protected $stepId;
   ...
   *
   * @var \Drupal\bfss_registration_form\Manager\StepManager
   */
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($buttons as $button) {
      /** @var \Drupal\bfss_registration_form\Button\ButtonInterface $button */
