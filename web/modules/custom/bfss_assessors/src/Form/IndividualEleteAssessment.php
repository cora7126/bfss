...
/**
 * @file
 * Contains \Drupal\bfss_assessors\Form\IndividualEleteAssessment.
 */
...
class IndividualEleteAssessment extends FormBase {
  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'IndividualEleteAssessment';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $booked_id = $param['booked_id'];
           ...
           $form_title = '<h2 class="st">STARTER/PROFESSIONAL ASSESSMENTS</h2>
                            <h2 class="el">ELITE ASSESSMENT</h2>';
          ...
          $form['form_fields_wrap']['elastic_strenght'] = array(
            ...
            //if($formtype == 'elete'){
               $form['form_fields_wrap']['elete'] = array(
                  '#type' => 'fieldset',
                  '#prefix' => '<div id="for_elete" class="for_elete">',
                  '#suffix' => '</div>',
                );

                //UE Power (SPM Ball Throw)
                $form['form_fields_wrap']['elete']['ue_power'] = array(
                  '#type' => 'fieldset',
                ...
                $form['form_fields_wrap']['elete']['ue_power']['power'] = array (
                 ...
                 //UE Power (SPM Ball Throw)
                 $form['form_fields_wrap']['elete']['ue_power_spm'] = array(
                  '#type' => 'fieldset',
                ...
                //UE Power (RM Ball Throw)
                 $form['form_fields_wrap']['elete']['ue_power_rm'] = array(
                  '#type' => 'fieldset',
                ...
                $form['form_fields_wrap']['elete']['strength_endurance'] = array(
                  '#type' => 'fieldset',
                ...
                //Change of Direction (5-10-5 Pro Agility Test)
                   $form['form_fields_wrap']['elete']['change_of_direction'] = array(
                  '#type' => 'fieldset',
