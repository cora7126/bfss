  ...
  $current_user = \Drupal::currentUser()->id();
    ...
    */
    ...
    '#suffix' => '</div>',
      ...
      $form['schoolname_1'] = [
            ...
            '#placeholder' => t('Orginization Name'),
            '#autocomplete_route_name' => 'edit_form.autocomplete',
            '#autocomplete_route_parameters' => array('state_name' => $VNS, 'org_type' => $type_organization_2, 'count' => 10), 
    ...
    */
    ...
    $form['schoolname_2'] = [
            ...
            '#placeholder' => t('Orginization Name'),
            '#autocomplete_route_name' => 'edit_form.autocomplete',
            '#autocomplete_route_parameters' => array('state_name' => $VNS, 'org_type' => $type_organization_3, 'count' => 10), 
